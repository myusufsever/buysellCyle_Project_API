Feature: As an administrator, I want to be able to create a new FAQ record via API connection.
  ...
  and the message in the response body should confirm: "Faqs added successfully".
    ...
    * The api user adds a key field "title" with a value "newFaqTitle" to the request body
    * The api user adds a key field "description" with a value "newFaqDescription" to the request body
